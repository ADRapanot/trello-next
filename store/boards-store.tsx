...
const INITIAL_BOARDS: Board[] = [
  ...
  },
  {
    ...
    background: "bg-gradient-to-br from-purple-500 to-purple-300",
    icon: "megaphone",
    isFavorite: false,
  },
  {
    id: "3",
    title: "Design System",
    background: "bg-gradient-to-br from-green-500 to-green-300",
    icon: "palette",
    isFavorite: true,
  },
  {
    ...
    background: "bg-gradient-to-br from-orange-500 to-orange-300",
    icon: "planning",
    isFavorite: false,
  },
  {
    ...
    background: "bg-gradient-to-br from-pink-500 to-pink-300",
    icon: "communication",
    isFavorite: false,
  },
  {
    ...
    background: "bg-gradient-to-br from-teal-500 to-teal-300",
    icon: "team",
    isFavorite: true,
  },
]
